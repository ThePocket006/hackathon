...
<section id="main-slider">
    <div class="owl-carousel">
        <div class="item" style="background-image: url(<?= assets_url('images/slider/bg1.jpg') ?>);">
        ...
        <div class="item" style="background-image: url(<?= assets_url('images/slider/bg2.jpg') ?>);">
            <div class="slider-inner">
                <div class="container">
                    <div class="row">
                        <div class="col-sm-6">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <img class="img-responsive" src="<?= assets_url('images/main-feature.png') ?>" alt="">
            </div>
            <div class="col-sm-6">
        ...
        <div class="portfolio-items">
            <div class="portfolio-item filter1">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/01.jpg') ?>" alt="">
            ...
            <div class="portfolio-item filter2 filter3">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/02.jpg') ?>" alt="">
                    <div class="portfolio-info">
            ...
            <div class="portfolio-item filter1">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/03.jpg') ?>" alt="">
                    <div class="portfolio-info">
                        <h3>Neque porro</h3>
            ...
            <div class="portfolio-item filter2">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/04.jpg') ?>" alt="">
                    <div class="portfolio-info">
            ...
            <div class="portfolio-item filter1 filter3">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/05.jpg') ?>" alt="">
                    <div class="portfolio-info">
            ...
            <div class="portfolio-item filter2">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/06.jpg') ?>" alt="">
                    <div class="portfolio-info">
            ...
            <div class="portfolio-item filter1 filter3">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/07.jpg') ?>" alt="">
                    <div class="portfolio-info">
                        <h3>Quis nostrum</h3>
            ...
            <div class="portfolio-item filter2">
                <div class="portfolio-item-inner">
                    <img class="img-responsive" src="<?= assets_url('images/portfolio/08.jpg') ?>" alt="">
                    <div class="portfolio-info">
        ...
        <div class="row">
            <div class="col-sm-6 col-md-3">
                <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="0ms">
                    <div class="team-img">
                        <img class="img-responsive img-circle" src="<?= assets_url('images/team/01.jpg') ?>" alt="">
                    </div>
                    <div class="team-info">
                        <h3>Jane Dohan</h3>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="100ms">
                    <div class="team-img">
                        <img class="img-responsive img-circle" src="<?= assets_url('images/team/02.jpg') ?>" alt="">
                    </div>
                    <div class="team-info">
                        <h3>Leny Fuston</h3>
                        <span>Accounter</span>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="200ms">
                    <div class="team-img">
                        <img class="img-responsive img-circle" src="<?= assets_url('images/team/03.jpg') ?>" alt="">
                    </div>
                    <div class="team-info">
                        <h3>Sander Bell</h3>
                        <span>Designer</span>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="team-member wow fadeInUp" data-wow-duration="400ms" data-wow-delay="300ms">
                    <div class="team-img">
                        <img class="img-responsive img-circle" src="<?= assets_url('images/team/04.jpg') ?>" alt="">
                    </div>
                    <div class="team-info">
                ...
                <div id="carousel-testimonial" class="carousel slide text-center" data-ride="carousel">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            <p><img class="img-circle img-thumbnail" src="<?= assets_url('images/testimonial/01.jpg') ?>" alt=""></p>
                        ...
                        <div class="item">
                            <p><img class="img-circle img-thumbnail" src="<?= assets_url('images/testimonial/02.jpg') ?>" alt=""></p>
